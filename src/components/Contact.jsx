      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12">
          <div>
            ...
            <p className="mt-3 text-white/70">Share a few details and our team will get back within 24 hours.</p>
          ...
          <form onSubmit={handleSubmit} className="border border-white/10 rounded-xl p-6 bg-white/[0.03]">
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <input className="bg-black/40 border border-white/10 rounded-md px-3 py-2" name="subject" placeholder="Subject" value={form.subject} onChange={handleChange} required />
              <select className="bg-black/40 border border-white/10 rounded-md px-3 py-2" name="service" value={form.service} onChange={handleChange}>
              ...
              <select className="bg-black/40 border border-white/10 rounded-md px-3 py-2" name="budget" value={form.budget} onChange={handleChange}>
            ...
            <input className="mt-4 w-full bg-black/40 border border-white/10 rounded-md px-3 py-2" name="timeline" placeholder="Timeline (e.g. Q1 2025)" value={form.timeline} onChange={handleChange} />
            <textarea className="mt-4 w-full bg-black/40 border border-white/10 rounded-md px-3 py-2 h-32" name="message" placeholder="Project details" value={form.message} onChange={handleChange} required />
            <button type="submit" disabled={status.loading} className="mt-4 w-full bg-yellow-400 text-black font-semibold px-6 py-3 rounded-md hover:bg-yellow-300 transition">
